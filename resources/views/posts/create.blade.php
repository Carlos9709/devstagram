...
<div class="md:flex md:justify-center md:gap-10 md:items-center">
    ...
    <div class="md:w-1/2 bg-white p-6 rounded-lg shadow-xl mt-10 md:mt-0">
        <form action="{{ route('posts.store') }}" method="POST" novalidate>
            @csrf
            <div class="mb-5">
                <label for="titulo" class="mb-2 bloc uppercase text-gray-500 font-bold">Titulo</label>
                <input type="text" name="titulo" id="titulo" placeholder="Tu titulo" class="border p-3 w-full rounded-lg
            ...
            <div class="mb-5">
                <label for="descripcion" class="mb-2 bloc uppercase text-gray-500 font-bold">Descripcion</label>
                <textarea name="descripcion" id="descripcion" placeholder="Tu descripcion" class="border p-3 w-full rounded-lg
            ...
            <input type="submit" value="Crear Publicacion" class="bg-sky-600 hover:bg-sky-700
